# Maze Escape Simulator is a grid based maze simulation demonstrating the application of the Breadth-First Search (BFS) algorithm
# in a dynamic, multi-agent environment. Multiple autonomous agents navigate a connected maze to collect keys and unlock an exit gate
# to escape while a player hunts them down.
